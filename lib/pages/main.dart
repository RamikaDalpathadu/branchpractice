...
class TriEaseApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'TriEase - Serenity Mode',
      debugShowCheckedModeBanner: false,
      home: const ImmersiveSerenityPage(),
    );
  }
}
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (_) => const SceneSelectionPage()));
                      },
            ...
            return GestureDetector(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(
                  builder: (_) => AudioSelectionPage(sceneName: scenes[index]['name']!),
                ));
              },
              child: Container(
...
class AudioSelectionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (sceneName == "Forest Walk") {
      audios = [
        {"name": "Forest Calm", "file": "af1.mp3"},
        {"name": "Forest Deep", "file": "af2.mp3"},
        {"name": "Forest Mystic", "file": "af3.mp3"},
      ];
    } else if (sceneName == "Beach") {
      audios = [
        {"name": "Beach Waves", "file": "ab1.mp3"},
        {"name": "Beach Breeze", "file": "ab2.mp3"},
        {"name": "Beach Sunset", "file": "ab3.mp3"},
      ];
    } else if (sceneName == "Rain") {
      audios = [
        {"name": "Rain Soft", "file": "ar1.mp3"},
        {"name": "Rain Calm", "file": "ar2.mp3"},
        {"name": "Rain Heavy", "file": "ar3.mp3"},
      ];
    }
...
class ScenePlayPage extends StatefulWidget {
  ...
  const ScenePlayPage({required this.sceneName, required this.audioFile, super.key});
