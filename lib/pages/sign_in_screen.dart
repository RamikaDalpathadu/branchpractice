...
class SignInScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 199, 233, 226),
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 136, 231, 207),
        ...
        children: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              elevation: 0,
              backgroundColor: const Color.fromARGB(255, 28, 165, 147),
    ...
    return Row(
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: const Text(
            "Sign Up",
            style: TextStyle(color: Color.fromARGB(255, 26, 156, 124)),
          ),
        ),
      ],
    );
